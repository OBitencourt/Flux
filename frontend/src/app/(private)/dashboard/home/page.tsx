                ...
                <div className="pl-24 pr-20 py-8">
                    <div className="flex flex-col">
                        ...
                        <div className="flex gap-8 mt-6">
                            ...
                            <div className="w-[33%] py-10 pr-20 pl-8 flex justify-start items-center border border-(--border-muted) rounded-2xl bg-(--foreground-color) hover:bg-(--border-muted) transition duration-150 ease-in-out shadow-[0px_9px_0px_0px_rgba(50,_50,_50,_1)] gap-4 relative">
                                <div className="p-4 bg-[#1E1E1E] rounded-xl z-1">
