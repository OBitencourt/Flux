                            ...
                            <div className="mt-3 flex gap-3 items-center">
                                {
                                    filteredTechs.length > 0 ? (
                                        filteredTechs.map((tech) => {
                                            ...
                                            return (
                                                <div key={tech.name} className="flex justify-center items-center p-2 border border-border-muted bg-dark-bg rounded-md">
                                ...
                                <div className="rounded-lg text-primary border border-primary flex items-center justify-center px-3 py-2 hover:bg-dark-bg transition duration-75 ease-in text-sm">
                                    Frontend
                                </div>
                            </div>
                        </div>
