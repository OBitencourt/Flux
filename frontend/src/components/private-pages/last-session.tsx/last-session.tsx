            ...
            <div className="w-[90%] py-6 px-5 border-1 border-(--border-muted) rounded-3xl ">
                <div className="flex flex-col">
                    ...
                    <div className="border-t-1 border-(--border-muted) py-4 hover:brightness-125 transition duration-150 ease-in-out cursor-pointer">
                        <div className="bg-(--foreground-color) py-3 px-5 rounded-xl flex flex-col hover:border-1 hover:border-(--border-muted) border-1 border-transparent">
                            <div className="flex justify-between items-center">

                                <h3 className="font-medium text-(--text-light) opacity-80">Criando sessão de contatos</h3>
                                <div className="bg-(--cp) p-2 text-(--foreground-color) rounded-md text-sm font-bold">
                                    57:32
                                </div>
                            ...
                            <div className="mt-3 flex gap-3 items-center">
                                ...
                                <div className="rounded-lg text-(--cp) border-1 border-(--cp) flex items-center justify-center px-3 py-2 hover:bg-(--dark-bg) transition duration-75 ease-in text-sm">
                                    Frontend
                                </div>
                            </div>
                        </div>
